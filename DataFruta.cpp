...
public:
    ...
    virtual void mostrarPrimeirosNElementos(int N) const = 0;
    virtual ~Lista() {}
...
public:
    ...
    void mostrarPrimeirosNElementos(int N) const override {
...
public:
    ...
    void mostrarPrimeirosNElementos(int N) const override {
        cout << "Os primeiras " << N << " datas:" << endl;
        int count = 0;
...
public:
    ...
    void mostrarPrimeirosNElementos(int N) const override {
        ...
        int count = 0;
        for (const auto& ListaSalarios : lista) {
            if (count >= N) {
                break;
            }
            cout << ListaSalarios << endl;
            ++count;
        }
    }
};
...
public:
    ...
    void mostrarPrimeirosNElementos(int N) const override {
        ...
        int count = 0;
        for (const auto& ListaIdades : lista) {
            if (count >= N) {
                break;
            }
            cout << ListaIdades << endl;
            ++count;
        }
    }
};
